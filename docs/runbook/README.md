...
> 📋 Encrypted operations documentation for the pdf-to-html converter project
...
> ⚠️ **Important:** The password is only used during deployment. Users accessing the runbook will need to enter this password to decrypt and view the content.
...
- ℹ️ The raw `index.html` is committed to the repository (team members with repo access can view it)
...
### ⚠️ Password prompt doesn't appear
